...
use CodeIgniter\{Filters\FilterInterface, HTTP\RequestInterface, HTTP\ResponseInterface};
use Config\App;
...
class LoginFilter implements FilterInterface
{
	...
	public function before(RequestInterface $request, $params = null)
	{
		...
		if (in_array((string) $current, [route_to('login'), route_to('forgot'), route_to('reset-password'), route_to('register'), route_to('activate-account')], true)) return;
