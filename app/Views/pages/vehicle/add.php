				...
				<div class="col-lg-8">
					<div class="card">
						<div class="card-body p-5">
							<div class="row mb-3">
								...
								<div class="col-lg-6">
									<div class="form-group mb-4">
										...
										<input type="text" id="vehicle_brand" name="vehicle_brand" class="form-control form-control-lg <?php $validation->hasError('vehicle_brand') && print 'is-invalid'; ?>" placeholder="Vehicle Brand" value="<?= old('vehicle_brand'); ?>">
								...
								<div class="col-lg-6">
									<div class="form-group mb-4">
										...
										<input type="text" id="vehicle_modal" name="vehicle_modal" class="form-control form-control-lg <?php $validation->hasError('vehicle_modal') && print 'is-invalid'; ?>" placeholder="Vehicle Modal" value="<?= old('vehicle_modal'); ?>">
								...
								<div class="col-lg-6">
									<div class="form-group mb-4">
										...
										<input type="text" id="vehicle_color" name="vehicle_color" class="form-control form-control-lg <?php $validation->hasError('vehicle_color') && print 'is-invalid'; ?>" placeholder="Vehicle Color" value="<?= old('vehicle_color'); ?>">
								...
								<div class="col-lg-6">
									<div class="form-group mb-4">
										...
										<input type="text" id="vehicle_number" name="vehicle_number" class="form-control form-control-lg <?php $validation->hasError('vehicle_number') && print 'is-invalid'; ?>" placeholder="Vehicle Number" value="<?= old('vehicle_number'); ?>">
								...
								<div class="col-lg-6">
									<div class="form-group mb-4">
										...
										<input type="text" id="vehicle_seats" name="vehicle_seats" class="form-control form-control-lg <?php $validation->hasError('vehicle_seats') && print 'is-invalid'; ?>" placeholder="Vehicle Seats" value="<?= old('vehicle_seats'); ?>">
							...
							<div class="mt-3">
								<button type="submit" class="btn btn-lg btn-success">Add Vehicle</button>
							</div>
