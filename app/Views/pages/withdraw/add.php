	...
	<div class="page-title">
		<div class="row">
			<div class="col-12 col-md-6 order-md-1 order-last">
				<h3>Add Withdraw</h3>
				<p class="text-subtitle text-muted">For user to add withdraw</p>
			</div>
			<div class="col-12 col-md-6 order-md-2 order-first">
				<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Add Withdraw</li>
					</ol>
				</nav>
			</div>
		</div>
					...
					<div class="card">
						<div class="card-body p-5">
							<div class="row mb-3">
								...
								<div class="col-lg-6">
									<?= select_box('status', 'Status', ['pending' => 'Pending', 'rejected' => 'Rejected'], $validation); ?>
								</div>

							</div>

							<div class="mt-3">
								<button type="submit" class="btn btn-lg btn-success">Add Withdraw</button>
							</div>
