							...
							<div class="row mb-3">
								<div class="col-lg-12">
									<div class="form-group mb-4">
										...
										<input type="text" id="name" name="name" class="form-control form-control-lg <?php $validation->hasError('name') && print 'is-invalid'; ?>" placeholder="Category Name" value="<?= old('name') ?? esc($category->getCategoryName(false)); ?>">
								...
								<div class="col-lg-12">
									<div class="form-group mb-4">
										...
										<textarea type="text" id="description" name="description" class="form-control form-control-lg <?php $validation->hasError('description') && print 'is-invalid'; ?>" placeholder="Category Description" value=""><?= old('description') ?? esc($category->category_description); ?></textarea>
					...
					<div class="card">
						<div class="card-body p-5">
							<div class="form-group mb-4">
								...
								<small>FileType: png, jpg, jpeg below 2MB</small>
								<?php if (null !== $category->category_icon) : ?>
									<input type="hidden" class="prev-image-upload" value="<?= esc($category->category_icon); ?>">
								<?php endif ?>
