...
function logged_in()
{
	return service('authentication', 'app', new UserModel())->check();
}
...
function user()
{
	$authenticate = service('authentication', 'app', new UserModel());
	$authenticate->check();
...
{
	$authenticate = service('authentication', 'app', new UserModel());
	$authorize    = service('authorization', new GroupModel(), null, new UserModel());
