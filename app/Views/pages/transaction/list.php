	...
	<div class="page-title">
		<div class="row">
			<div class="col-12 col-md-6 order-md-1 order-last">
				<h3>Transactions</h3>
				<p class="text-subtitle text-muted">For user to check transactions list</p>
			</div>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table" id="table1">
						...
						<tbody>
							<?php $i = 0; ?>
							<?php if (is($transactions, 'array')) foreach ($transactions as $data) : ?>
								<tr>
									<td><?= ++$i; ?></td>
									<td>
										<h3><?= $data->txn; ?></h3>
									...
									<td>
										<?= badge(['payment-gateway' => 'secondary', 'card' => 'warning', 'cash' => 'danger', 'virtual' => 'info'], $data->transaction_type) ?>
									</td>
