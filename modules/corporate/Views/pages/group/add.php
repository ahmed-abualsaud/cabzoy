			...
			<div class="col-12 col-md-6 order-md-2 order-first">
				<nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Create Company's Group</li>
					</ol>
				</nav>
			</div>
		</div>
							...
							<div class="row mb-3">
								<div class="col-md-6">
									<div class="form-group mb-4">
										...
										<input type="text" id="title" name="title" class="form-control form-control-lg <?php $validation->hasError('title') && print 'is-invalid'; ?>" placeholder="Group Name" value="<?= old('title'); ?>">
								...
								<div class="col-lg-6">
									...
									<?= select_box('policy_id', 'Policies', $policy, $validation); ?>
								</div>
								<div class="col-md-12">
									<div class="form-group mb-4">
										<label class="mb-2" for="detail">Group Description</label>
										<input type="text" id="detail" name="detail" class="form-control form-control-lg <?php $validation->hasError('detail') && print 'is-invalid'; ?>" placeholder="Group Description" value="<?= old('detail'); ?>">
