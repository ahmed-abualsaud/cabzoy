									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="flex-grow-1 ms-3">
												...
												<a href="<?= !in_groups('creators') && config('Settings')->enableHideSensitiveInfo ? 'javascript:void(0)' : "mailto://" . $data->user->email; ?>" class="text-truncate text-dark" data-bs-toggle="tooltip" data-bs-placement="top" title="Send mail to user">
													<?= !in_groups('creators') && config('Settings')->enableHideSensitiveInfo ? encrypt($data->user->email, 2, true) : $data->user->email; ?>
												</a>
											</div>
										</div>
									</td>
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="flex-grow-1 ms-3">
												...
												<a href="<?= !in_groups('creators') && config('Settings')->enableHideSensitiveInfo ? 'javascript:void(0)' : "mailto://" . $data->company->company_email; ?>" class="text-truncate text-dark" data-bs-toggle="tooltip" data-bs-placement="top" title="Send mail to user">
													<?= !in_groups('creators') && config('Settings')->enableHideSensitiveInfo ? encrypt($data->company->company_email, 2, true) : $data->company->company_email; ?>
												</a>
											</div>
										</div>
									</td>
