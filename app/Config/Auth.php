...
class Auth extends \Myth\Auth\Config\Auth
{
	...
	public $authenticationLibs = [
		...
		'app'   => 'App\Libraries\AppAuthenticator',
	];
	...
	public $views = [
		...
		'forgot'          => 'App\Views\pages\auth\forgot',
		'emailForgot'     => 'App\Views\pages\email\forgot',
		'register'        => 'App\Views\pages\auth\register',
		'emailActivation' => 'App\Views\pages\email\activation',
	];
	 ...
	 * @var string[]
	 */
	public $validFields = ['email', 'username', 'phone'];
	 ...
	 * @var string[]
	 */
	public $personalFields = ['firstname', 'lastname', 'profile_pic', 'speed', 'heading', 'lat', 'long', 'is_online', 'app_token'];
	 ...
	 * need extreme protection, like dealing with users financial) that
